...
export default async function DeciduousPage({
  params,
}: {
  ...
  const taxonId = 47853; // Fagales (oaks, beeches, birches, walnuts)
  ...
  return (
    <main className="min-h-screen p-8">
      ...
      <h2 className="text-2xl text-gray-600 mb-8">Deciduous Trees</h2>
      
      <section>
        {plants.length === 0 ? (
          <p className="text-gray-600">Loading deciduous tree data...</p>
        ) : (
